...
#
# This script updates:
#   - chip-for-givewp.php  (Version header + GWP_CHIP_MODULE_VERSION)
...
CURRENT_VERSION=$(grep "Version:" chip-for-givewp.php | head -1 | awk '{print $3}')
...
# chip-for-givewp.php — Version header
sed -i.bak "s/^ \* Version: ${CURRENT_VERSION}/ * Version: ${NEW_VERSION}/" chip-for-givewp.php
rm -f chip-for-givewp.php.bak

# chip-for-givewp.php — GWP_CHIP_MODULE_VERSION constant
sed -i.bak "s/GWP_CHIP_MODULE_VERSION', 'v${CURRENT_VERSION}'/GWP_CHIP_MODULE_VERSION', 'v${NEW_VERSION}'/" chip-for-givewp.php
rm -f chip-for-givewp.php.bak
